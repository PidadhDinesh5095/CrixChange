...
const CricketTradingChart = () => {
	...
	const [selectedInterval, setSelectedInterval] = useState("1o");
	const [chartType, setChartType] = useState("candlestick");
	const selectedTeam = IPL_TEAMS.find((t) => t.id === "csk"); 
