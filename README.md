...
│   ├── models/
│   ├── routes/
│   ├── utils/ngoDB models for users, wallets, blacklisted tokens, etc.
...
```bash
cd backend
npm run devngoDB models for users, wallets, blacklisted tokens, etc.
...
---ngoDB models for users, wallets, blacklisted tokens, etc.
